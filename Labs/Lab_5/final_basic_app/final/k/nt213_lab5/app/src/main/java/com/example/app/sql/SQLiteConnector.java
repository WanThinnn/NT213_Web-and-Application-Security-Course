...
public class SQLiteConnector extends SQLiteOpenHelper {
    ...
    public boolean checkUser(String username, String password) {
        ...
        Cursor cursor = null;
        try {
            // Sử dụng TABLE_USER để đảm bảo tính nhất quán
            ...
            if (cursor != null && cursor.moveToFirst()) {
                String hashedPassword = cursor.getString(cursor.getColumnIndex(COLUMN_USER_PASSWORD));
                // Kiểm tra mật khẩu nhập vào với mật khẩu lưu trong DB
