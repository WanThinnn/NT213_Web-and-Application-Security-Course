...
.method public a(Lj/m;Z)V
    ...
    :cond_1
    iget-object v4, p0, Lf/q;->b:Lf/A;

    iget-object v5, v4, Lf/A;->M:[Lf/z;
    ...
    invoke-virtual {v4, p1, v7, v0}, Lf/A;->p(ILf/z;Lj/m;)V
    ...
    :pswitch_0
    iget-object p2, p0, Lf/q;->b:Lf/A;

    invoke-virtual {p2, p1}, Lf/A;->q(Lj/m;)V
...
.method public c(Lj/m;)Z
    ...
    iget-object v0, p0, Lf/q;->b:Lf/A;

    iget-boolean v1, v0, Lf/A;->G:Z

    if-eqz v1, :cond_0

    iget-object v1, v0, Lf/A;->l:Landroid/view/Window;
...
.method public g(Landroid/view/View;LK/h0;)LK/h0;
    ...
    invoke-virtual/range {p2 .. p2}, LK/h0;->d()I

    move-result v3

    move-object/from16 v4, p0

    iget-object v5, v4, Lf/q;->b:Lf/A;
    ...
    iget-object v0, v5, Lf/A;->v:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    iget-object v0, v5, Lf/A;->d0:Landroid/graphics/Rect;
    ...
    iput-object v0, v5, Lf/A;->d0:Landroid/graphics/Rect;

    new-instance v0, Landroid/graphics/Rect;

    invoke-direct {v0}, Landroid/graphics/Rect;-><init>()V

    iput-object v0, v5, Lf/A;->e0:Landroid/graphics/Rect;

    :cond_0
    iget-object v12, v5, Lf/A;->d0:Landroid/graphics/Rect;

    iget-object v0, v5, Lf/A;->e0:Landroid/graphics/Rect;

    invoke-virtual/range {p2 .. p2}, LK/h0;->b()I
    ...
    invoke-virtual/range {p2 .. p2}, LK/h0;->c()I
    ...
    iget-object v8, v5, Lf/A;->B:Landroid/view/ViewGroup;
    ...
    :cond_1
    sget-boolean v14, LR0/e;->g:Z

    const-string v15, "ViewUtils"

    if-nez v14, :cond_2

    sput-boolean v11, LR0/e;->g:Z
    ...
    sput-object v7, LR0/e;->h:Ljava/lang/reflect/Method;
    ...
    sget-object v7, LR0/e;->h:Ljava/lang/reflect/Method;
    ...
    iget-object v12, v5, Lf/A;->B:Landroid/view/ViewGroup;

    sget-object v13, LK/K;->a:Ljava/util/WeakHashMap;

    invoke-static {v12}, LK/E;->a(Landroid/view/View;)LK/h0;
    ...
    :goto_5
    iget-object v8, v5, Lf/A;->k:Landroid/content/Context;

    if-lez v0, :cond_8

    iget-object v0, v5, Lf/A;->D:Landroid/view/View;
    ...
    iput-object v0, v5, Lf/A;->D:Landroid/view/View;
    ...
    iget-object v13, v5, Lf/A;->D:Landroid/view/View;
    ...
    iget-object v9, v5, Lf/A;->D:Landroid/view/View;
    ...
    iget-object v8, v5, Lf/A;->v:Landroidx/appcompat/widget/ActionBarContextView;
    ...
    :cond_12
    :goto_a
    iget-object v5, v5, Lf/A;->D:Landroid/view/View;
    ...
    invoke-direct {v7, v2}, LK/Y;-><init>(LK/h0;)V
    ...
    invoke-direct {v7, v2}, LK/X;-><init>(LK/h0;)V
    ...
    invoke-direct {v7, v2}, LK/W;-><init>(LK/h0;)V
    ...
    invoke-virtual {v7, v0}, LK/Z;->g(LC/d;)V

    invoke-virtual {v7}, LK/Z;->b()LK/h0;
    ...
    invoke-virtual {v0}, LK/h0;->f()Landroid/view/WindowInsets;

    move-result-object v2

    if-eqz v2, :cond_18

    invoke-static {v1, v2}, LK/B;->b(Landroid/view/View;Landroid/view/WindowInsets;)Landroid/view/WindowInsets;
    ...
    invoke-static {v1, v3}, LK/h0;->g(Landroid/view/View;Landroid/view/WindowInsets;)LK/h0;
