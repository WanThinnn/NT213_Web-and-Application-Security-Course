...
.method public constructor <init>(Landroid/content/Context;Landroid/util/AttributeSet;)V
    ...
    iput-boolean v6, p0, Lk/u0;->a:Z

    const/4 v7, -0x1

    iput v7, p0, Lk/u0;->b:I

    const/4 v8, 0x0

    iput v8, p0, Lk/u0;->c:I

    const v0, 0x800033

    iput v0, p0, Lk/u0;->e:I

    sget-object v2, Le/a;->n:[I

    invoke-static {p1, p2, v2, v5, v8}, LK/k;->t(Landroid/content/Context;Landroid/util/AttributeSet;[III)LK/k;

    move-result-object v9

    iget-object v0, v9, LK/k;->c:Ljava/lang/Object;
    ...
    iget-object p1, v9, LK/k;->c:Ljava/lang/Object;
    ...
    invoke-virtual {p0, p2}, Lk/u0;->setOrientation(I)V
    ...
    invoke-virtual {p0, p2}, Lk/u0;->setGravity(I)V
    ...
    invoke-virtual {p0, p2}, Lk/u0;->setBaselineAligned(Z)V
    ...
    iput-boolean p2, p0, Lk/u0;->h:Z

    const/4 p2, 0x5

    invoke-virtual {v9, p2}, LK/k;->i(I)Landroid/graphics/drawable/Drawable;

    move-result-object p2

    invoke-virtual {p0, p2}, Lk/u0;->setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    iput p1, p0, Lk/u0;->o:I

    invoke-virtual {v9}, LK/k;->v()V
...
.method public final d(Landroid/graphics/Canvas;I)V
    ...
    iget-object v0, p0, Lk/u0;->k:Landroid/graphics/drawable/Drawable;

    invoke-virtual {p0}, Landroid/view/View;->getPaddingLeft()I

    move-result v1

    iget v2, p0, Lk/u0;->o:I
    ...
    iget v3, p0, Lk/u0;->o:I

    sub-int/2addr v2, v3

    iget v3, p0, Lk/u0;->m:I

    add-int/2addr v3, p2

    invoke-virtual {v0, v1, p2, v2, v3}, Landroid/graphics/drawable/Drawable;->setBounds(IIII)V

    iget-object p2, p0, Lk/u0;->k:Landroid/graphics/drawable/Drawable;
...
.method public g(Landroid/util/AttributeSet;)Lk/t0;
    .locals 2
...
.method public bridge synthetic generateDefaultLayoutParams()Landroid/view/ViewGroup$LayoutParams;
    ...
    invoke-virtual {p0}, Lk/u0;->f()Lk/t0;
...
.method public bridge synthetic generateLayoutParams(Landroid/util/AttributeSet;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 1
    invoke-virtual {p0, p1}, Lk/u0;->g(Landroid/util/AttributeSet;)Lk/t0;
...
.method public bridge synthetic generateLayoutParams(Landroid/view/ViewGroup$LayoutParams;)Landroid/view/ViewGroup$LayoutParams;
    ...
    .line 2
    invoke-virtual {p0, p1}, Lk/u0;->h(Landroid/view/ViewGroup$LayoutParams;)Lk/t0;
...
.method public getBaseline()I
    ...
    :cond_2
    iget v2, p0, Lk/u0;->c:I

    iget v3, p0, Lk/u0;->d:I

    const/4 v4, 0x1

    if-ne v3, v4, :cond_5

    iget v3, p0, Lk/u0;->e:I
...
.method public getWeightSum()F
    ...
    iget v0, p0, Lk/u0;->g:F

    return v0
.end method

.method public h(Landroid/view/ViewGroup$LayoutParams;)Lk/t0;
    .locals 1
...
.method public final onDraw(Landroid/graphics/Canvas;)V
    ...
    invoke-virtual {p0}, Lk/u0;->getVirtualChildCount()I
    ...
    invoke-virtual {p0, v2}, Lk/u0;->i(I)Z
    ...
    iget v5, p0, Lk/u0;->m:I

    sub-int/2addr v4, v5

    invoke-virtual {p0, p1, v4}, Lk/u0;->d(Landroid/graphics/Canvas;I)V
    ...
    :cond_2
    invoke-virtual {p0, v0}, Lk/u0;->i(I)Z
    ...
    :goto_1
    invoke-virtual {p0, p1, v0}, Lk/u0;->d(Landroid/graphics/Canvas;I)V
    ...
    iget v6, p0, Lk/u0;->l:I

    sub-int/2addr v5, v6

    :goto_3
    invoke-virtual {p0, p1, v5}, Lk/u0;->e(Landroid/graphics/Canvas;I)V
    ...
    :goto_5
    invoke-virtual {p0, p1, v0}, Lk/u0;->e(Landroid/graphics/Canvas;I)V
...
.method public onLayout(ZIIII)V
    ...
    invoke-virtual/range {p0 .. p0}, Lk/u0;->getVirtualChildCount()I

    move-result v12

    iget v13, v0, Lk/u0;->e:I
    ...
    :goto_3
    invoke-virtual {v0, v4}, Lk/u0;->i(I)Z

    move-result v6

    if-eqz v6, :cond_6

    iget v6, v0, Lk/u0;->m:I
    ...
    iget v12, v0, Lk/u0;->e:I

    and-int/2addr v8, v12

    and-int/lit8 v12, v12, 0x70

    iget-boolean v13, v0, Lk/u0;->a:Z

    iget-object v14, v0, Lk/u0;->i:[I

    iget-object v15, v0, Lk/u0;->j:[I
    ...
    :goto_b
    invoke-virtual {v0, v5}, Lk/u0;->i(I)Z

    move-result v5

    if-eqz v5, :cond_16

    iget v5, v0, Lk/u0;->l:I
...
.method public onMeasure(II)V
    ...
    iget v0, v6, Lk/u0;->b:I

    iget-boolean v9, v6, Lk/u0;->h:Z
    ...
    iget v4, v6, Lk/u0;->f:I

    iput v4, v6, Lk/u0;->f:I
    ...
    :cond_1
    invoke-virtual {v6, v13}, Lk/u0;->i(I)Z
    ...
    iget v0, v6, Lk/u0;->f:I

    iput v0, v6, Lk/u0;->c:I
    ...
    invoke-virtual {v6, v10}, Lk/u0;->i(I)Z
    ...
    iget v4, v6, Lk/u0;->m:I

    add-int/2addr v0, v4

    iput v0, v6, Lk/u0;->f:I
    ...
    iget v13, v6, Lk/u0;->f:I

    iput v13, v6, Lk/u0;->f:I
    ...
    iget-object v0, v6, Lk/u0;->i:[I

    const/4 v12, 0x4

    if-eqz v0, :cond_29

    iget-object v0, v6, Lk/u0;->j:[I
    ...
    iput-object v0, v6, Lk/u0;->i:[I

    new-array v0, v12, [I

    iput-object v0, v6, Lk/u0;->j:[I

    :cond_2a
    iget-object v13, v6, Lk/u0;->i:[I

    iget-object v14, v6, Lk/u0;->j:[I
    ...
    iget-boolean v5, v6, Lk/u0;->a:Z

    iget-boolean v4, v6, Lk/u0;->h:Z
    ...
    iget v7, v6, Lk/u0;->f:I

    iput v7, v6, Lk/u0;->f:I
    ...
    :cond_2d
    invoke-virtual {v6, v3}, Lk/u0;->i(I)Z
    ...
    invoke-virtual {v6, v9}, Lk/u0;->i(I)Z
...
.method public setDividerDrawable(Landroid/graphics/drawable/Drawable;)V
    ...
    :cond_0
    iput-object p1, p0, Lk/u0;->k:Landroid/graphics/drawable/Drawable;
    ...
    iput v1, p0, Lk/u0;->l:I

    invoke-virtual {p1}, Landroid/graphics/drawable/Drawable;->getIntrinsicHeight()I

    move-result v1

    iput v1, p0, Lk/u0;->m:I

    goto :goto_0

    :cond_1
    iput v0, p0, Lk/u0;->l:I

    iput v0, p0, Lk/u0;->m:I
