...
.method public constructor <init>(Landroidx/recyclerview/widget/RecyclerView;)V
    ...
    iput-object p1, p0, LZ/Y;->g:Landroidx/recyclerview/widget/RecyclerView;

    sget-object v0, Landroidx/recyclerview/widget/RecyclerView;->u0:LP/d;

    iput-object v0, p0, LZ/Y;->d:Landroid/view/animation/Interpolator;

    const/4 v1, 0x0

    iput-boolean v1, p0, LZ/Y;->e:Z

    iput-boolean v1, p0, LZ/Y;->f:Z
    ...
    iput-object v1, p0, LZ/Y;->c:Landroid/widget/OverScroller;
...
.method public final a()V
    ...
    iput-boolean v0, p0, LZ/Y;->f:Z

    goto :goto_0

    :cond_0
    iget-object v0, p0, LZ/Y;->g:Landroidx/recyclerview/widget/RecyclerView;
...
.method public final b(IIILandroid/view/animation/Interpolator;)V
    ...
    iget-object v1, p0, LZ/Y;->g:Landroidx/recyclerview/widget/RecyclerView;
    ...
    sget-object p4, Landroidx/recyclerview/widget/RecyclerView;->u0:LP/d;

    :cond_5
    iget-object p3, p0, LZ/Y;->d:Landroid/view/animation/Interpolator;

    if-eq p3, p4, :cond_6

    iput-object p4, p0, LZ/Y;->d:Landroid/view/animation/Interpolator;
    ...
    iput-object p3, p0, LZ/Y;->c:Landroid/widget/OverScroller;
    ...
    iget-object v3, p0, LZ/Y;->c:Landroid/widget/OverScroller;
...
.method public final run()V
    ...
    iget-object v9, v0, LZ/Y;->g:Landroidx/recyclerview/widget/RecyclerView;

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->l:LZ/K;

    if-nez v1, :cond_0

    invoke-virtual {v9, v0}, Landroid/view/View;->removeCallbacks(Ljava/lang/Runnable;)Z

    iget-object v1, v0, LZ/Y;->c:Landroid/widget/OverScroller;
    ...
    iput-boolean v10, v0, LZ/Y;->f:Z

    const/4 v11, 0x1

    iput-boolean v11, v0, LZ/Y;->e:Z

    invoke-virtual {v9}, Landroidx/recyclerview/widget/RecyclerView;->m()V

    iget-object v12, v0, LZ/Y;->c:Landroid/widget/OverScroller;
    ...
    :cond_2
    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->k:LZ/C;
    ...
    iget-object v3, v9, Landroidx/recyclerview/widget/RecyclerView;->l:LZ/K;

    iget-object v3, v3, LZ/K;->e:LZ/w;

    if-eqz v3, :cond_5

    iget-boolean v4, v3, LZ/w;->d:Z

    if-nez v4, :cond_5

    iget-boolean v4, v3, LZ/w;->e:Z

    if-eqz v4, :cond_5

    iget-object v4, v9, Landroidx/recyclerview/widget/RecyclerView;->c0:LZ/W;

    invoke-virtual {v4}, LZ/W;->b()I

    move-result v4

    if-nez v4, :cond_3

    invoke-virtual {v3}, LZ/w;->i()V
    ...
    invoke-virtual {v3, v1, v2}, LZ/w;->g(II)V
    ...
    :goto_5
    iget-object v2, v9, Landroidx/recyclerview/widget/RecyclerView;->l:LZ/K;

    iget-object v2, v2, LZ/K;->e:LZ/w;

    if-eqz v2, :cond_10

    iget-boolean v2, v2, LZ/w;->d:Z
    ...
    :cond_1b
    iput v10, v1, LZ/n;->c:I

    goto :goto_b

    :cond_1c
    :goto_a
    invoke-virtual/range {p0 .. p0}, LZ/Y;->a()V

    iget-object v1, v9, Landroidx/recyclerview/widget/RecyclerView;->a0:LZ/p;

    if-eqz v1, :cond_1d

    invoke-virtual {v1, v9, v15, v14}, LZ/p;->a(Landroidx/recyclerview/widget/RecyclerView;II)V
    ...
    iget-boolean v2, v1, LZ/w;->d:Z

    if-eqz v2, :cond_1e

    invoke-virtual {v1, v10, v10}, LZ/w;->g(II)V

    :cond_1e
    iput-boolean v10, v0, LZ/Y;->e:Z
